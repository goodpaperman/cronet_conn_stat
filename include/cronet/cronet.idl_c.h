...
CRONET_EXPORT
bool Cronet_UrlRequest_IsFailed(Cronet_UrlRequestPtr self);
CRONET_EXPORT
...
int64_t Cronet_UrlResponseInfo_received_byte_count_get(
    const Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
Cronet_String Cronet_UrlResponseInfo_remote_address(
    const Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
uint16_t Cronet_UrlResponseInfo_remote_port(
    const Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
int32_t Cronet_UrlResponseInfo_remote_addr_family(
    const Cronet_UrlResponseInfoPtr self);
CRONET_EXPORT
bool Cronet_UrlResponseInfo_did_use_quic(
    const Cronet_UrlResponseInfoPtr self);
...
CRONET_EXPORT
void Cronet_UrlRequestParams_disable_proxy_set(Cronet_UrlRequestParamsPtr self,
